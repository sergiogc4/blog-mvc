...
# 1. Asegurar que Helpers.php contiene todas las funciones
...
if (!function_exists('truncate')) {
    function truncate(string $text, int $length = 150, string $suffix = '...'): string
    {
        ...
        // Cortar en un espacio si es posible
...
# 2. Insertar la inclusión de Helpers.php en public/index.php si no existe
if ! grep -q "Helpers.php" public/index.php; then
    ...
    echo "✅ Helpers.php ya está incluido."
fi
